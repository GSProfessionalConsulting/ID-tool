...
class LessonTest < ActiveSupport::TestCase
  test "should be valid with valid attributes" do
    course = courses(:web_development)
    lesson = Lesson.new(
      title: "Test Lesson",
      course: course,
      position: 3,
  ...
  test "should require title" do
    course = courses(:web_development)
    lesson = Lesson.new(course: course, position: 4, lesson_type: "content")
  ...
  test "should require unique position within course" do
    course = courses(:web_development)
    Lesson.create!(title: "First Lesson", course: course, position: 10, lesson_type: "content")

    duplicate_lesson = Lesson.new(title: "Second Lesson", course: course, position: 10, lesson_type: "content")
